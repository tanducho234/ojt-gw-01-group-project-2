      ...
      <div className="border-t border-gray-300 py-5">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <img
              src="/public/assets/images/Visa.png"
              alt="Visa"
              className="h-12"
            />
            <img
              src="/public/assets/images/Badge.png"
              alt="Badge"
              className="h-12"
            />
            <img
              src="/public/assets/images/GooglePay.png"
              alt="Google Pay"
              className="h-12"
            />
            <img
              src="/public/assets/images/Pay.png"
              alt="VNPay"
              className="h-12"
            />
            <img
              src="/public/assets/images/VNPAY.png"
              alt="VNPay"
              className="h-12"
            />
          </div>
