...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-gray-800">
      {/* Newsletter Section */}
      <div className="flex justify-center items-center py-6 md:py-10 px-4 h-64" style={{ background: 'linear-gradient(to bottom, #FFFFFF 50%, #F0F0F0 50%)' }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col gap-4">
            <a href="/" className="text-xl font-bold text-black">
              <img src="/public/assets/images/Logofast.png" alt="Shop Logo" className="h-8 w-auto" />
            </a>
            ...
            <div className="flex items-center gap-4 md:gap-6">
              {/* Social Media Icons */}
              <a href="#" className="w-8 md:w-10 h-8 md:h-10 rounded-full border border-gray-200 flex items-center justify-center hover:border-gray-400 transition">
      ...
      <div className="border-t border-gray-300 py-5">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <img src="/public/assets/images/Visa.png" alt="Visa" className="h-12" />
            <img src="/public/assets/images/Badge.png"  alt="Badge" className="h-12"/>
            <img src="/public/assets/images/GooglePay.png" alt="Google Pay" className="h-12" />
            <img src="/public/assets/images/Pay.png" alt="VNPay" className="h-12" />
          </div>
        </div>
      </div>
    </footer>
